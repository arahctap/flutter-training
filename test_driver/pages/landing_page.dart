...
//   Future<void> tapPlusOneBtnForNTimes(
//       String key, int times, FlutterWorld world) async {
...
//   Future<void> compLandingPageTitleValue(
//       String value, FlutterWorld world) async {
//     final text = await BasePage.getText(
//         world.driver!, find.byValueKey(landingPageTitle));
